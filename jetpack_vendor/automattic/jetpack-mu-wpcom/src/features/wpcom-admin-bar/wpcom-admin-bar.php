 ...
 *
 * @deprecated 6.10.0-alpha Use Automattic\Jetpack\Connection\Urls::maybe_add_origin_site_id instead.
 *
...
function maybe_add_origin_site_id_to_url( $url ) {
	_deprecated_function( __FUNCTION__, 'jetpack-mu-wpcom-6.10.0-alpha', 'Automattic\Jetpack\Connection\Urls::maybe_add_origin_site_id' );
