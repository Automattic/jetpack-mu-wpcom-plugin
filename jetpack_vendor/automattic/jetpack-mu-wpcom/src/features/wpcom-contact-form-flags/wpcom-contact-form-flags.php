 ...
 *
 * @deprecated 6.11.0-alpha The gating it served is retired.
 *
...
function wpcom_forms_has_blog_sticker( $sticker, $blog_id ) {
	_deprecated_function( __FUNCTION__, 'jetpack-mu-wpcom-6.11.0-alpha' );
 ...
 *
 * @deprecated 6.11.0-alpha Central Forms Management is enabled for every site.
 *
 ...
 *
 * @deprecated 6.11.0-alpha Nothing disables Central Forms Management any more.
 */
 ...
 *
 * @deprecated 6.11.0-alpha The Forms package supplies the default.
 *
