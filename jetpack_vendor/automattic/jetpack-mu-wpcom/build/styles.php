 ...
 *
 * Note: These styles can be overridden by calling jetpack_mu_wpcom_override_style()
 ...
 */
function jetpack_mu_wpcom_override_style( $styles, $handle, $src, $deps = array(), $ver = false, $media = 'all' ) {
 ...
 * @param WP_Styles $styles WP_Styles instance.
 */
function jetpack_mu_wpcom_register_package_styles( $styles ) {
	...
	foreach ( $styles_data as $style_data ) {
		jetpack_mu_wpcom_override_style(
			$styles,
			$style_data['handle'],
...
add_action( 'wp_default_styles', 'jetpack_mu_wpcom_register_package_styles' );
