...
## [5.17.0-alpha] - unreleased

This is an alpha version! The changes listed here are not final.

### Added
- Added information regarding if github deployments is active to the wp-admin command palette config.
...
[5.17.0-alpha]: https://github.com/Automattic/jetpack-mu-wpcom/compare/v5.16.1...v5.17.0-alpha
