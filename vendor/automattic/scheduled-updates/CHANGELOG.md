...
### Added
- Add a new plugin deletion hook that remove the plugin from the scheduled updates.
...
[0.5.0-alpha]: https://github.com/Automattic/scheduled-updates/compare/v0.4.1...v0.5.0-alpha
